export const trabajos = [
    ...
    },
    {
        ...
        'logros': [
            ...
            "Gestión de estado global persistente (Carrito y Tema) utilizando LocalStorage.",
            "Consumo de API financiera para actualización de precios de mercado en tiempo real."
        ]
    },
    {
        'id': 'Proyecto3',
        ...
        'logros': [
            ...
            "Sistema de seguridad robusto con hashing de contraseñas y saneamiento de inputs.",
            "Diseño y normalización de base de datos relacional MySQL para gestión de contenidos."
        ]
    },
    {
        'id': 'Proyecto4',
